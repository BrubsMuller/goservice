...
public class ClienteController {
    ...
    public String cancelarAgendamento(
        ...
        } catch (UsuarioNaoEncontradoException | UsuarioNaoAutenticadoException | AgendamentoNaoEncontradoExceptions | StatusAgendamentoImutavelException ex) {
            attributes.addFlashAttribute("errorMessage", ex.getMessage());
        } catch (Exception ex) {
            attributes.addFlashAttribute("errorMessage", "Erro ao cancelar o agendamento.");
        }
        return "redirect:/cliente/historico";
    }
